...
class Snake(tk.Canvas):
    def __init__(self, parent):
        super().__init__(parent, width=600, height=620, background="black", highlightthickness=0)
    ...
    def create_objects(self):
        self.create_text(100, 12, text=f"Score {self.score} (speed: {moves_per_second})", tag="score", fill="#fff", font=("TkDefaultFont", 14))
    ...
    def check_collisions(self):
        ...
        return (head_x_position in (0, 600) or
    ...
    def end_game(self):
        self.delete(tk.ALL)
        self.create_text(self.winfo_width() / 2, self.winfo_height() / 2, text=f"Game over. Score: {self.score}",
                         fill="#fff", font=("TkDefaultFont", 24))
